              ...
              <Row>
                ...
                <Col xs={"auto"}>
                  <AnchorLink to={`/faculties/#Quiz`}>
                    <FormattedMessage
                      id="register.faculty.help"
                      defaultMessage="Do you need help with selection?"
                    />
                  </AnchorLink>
                </Col>
              </Row>
      ...
      {isFullCourse && (
        <Form.Group controlId="registerCourses">
          <FormattedMessage id="register.courses" defaultMessage="Courses">
            {(l_courses) => (
              <>
                <Form.Label>{l_courses}</Form.Label>
                <Row>
                  <Col sm={4}>
                    <FormattedMessage
                      ...
                      {(label) => (
                        <div className="switch-bg">
                          <Form.Check
                            ...
                            checked={biology}
                            onChange={(event) =>
                              setBiology(event.target.checked)
                            }
                          />
                        </div>
                      )}
                      ...
                      {(label) => (
                        <div className="switch-bg">
                          <Form.Check
                            ...
                            checked={chemistry}
                            onChange={(event) =>
                              setChemistry(event.target.checked)
                            }
                          />
                        </div>
                      )}
                  ...
                  <input
                    ...
                    value={[
                      biology
                        ? intl.formatMessage({ id: "register.course.biology" })
                        : "",
                      chemistry
                        ? intl.formatMessage({
                            id: "register.course.chemistry",
