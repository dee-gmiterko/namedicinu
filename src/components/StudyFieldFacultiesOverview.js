...
export default class StudyFieldFacultiesOverview extends Component {
  ...
  render() {
    const { studyField, faculties } = this.props;
    return (
          ...
          <Row>
            <Col>
              ...
              <div className="text-justify font-italic">
                <Markdown value={studyField.description} />
              </div>
            </Col>
          </Row>
        </Container>
            ...
            return (
              <div key={index} className="p-3">
                <Card>
                  ...
                  <Card.Body>
                    <Card.Title>
                      <AnchorLink to={`/field/${slugifyStudyField(studyField)}#${slugifyFaculty(faculty)}`}>
                  ...
                  <Card.Body className="flex-grow-0 d-flex justify-content-between">
                    <Button as={AnchorLink} to={`/field/${slugifyStudyField(studyField)}#${slugifyFaculty(faculty)}`}>
